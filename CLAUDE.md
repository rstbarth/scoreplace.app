...
- **Versao atual:** `0.16.3-alpha` (definida em `window.SCOREPLACE_VERSION` no store.js)
...
Arquivos modificados recentemente usam a versao atual (`?v=0.16.3`). Demais arquivos podem usar versoes anteriores - verificar ao fazer deploy e atualizar apenas os que foram modificados.
