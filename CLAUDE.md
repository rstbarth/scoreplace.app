...
- **Versao atual:** `0.16.15-alpha` (definida em `window.SCOREPLACE_VERSION` no store.js)
...
Arquivos modificados recentemente usam a versao atual (`?v=0.16.12`). Demais arquivos podem usar versoes anteriores - verificar ao fazer deploy e atualizar apenas os que foram modificados.
