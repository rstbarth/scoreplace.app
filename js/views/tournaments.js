function renderTournaments(container, tournamentId = null) {
    ...
    } // end of dead code block from old enrollment setup

    // Continue with the rest of the original code structure
    // (This section had other setup code that we're keeping)
