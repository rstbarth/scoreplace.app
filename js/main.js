  ...
  var helpSections = [
    ...
    },
    {
      ...
      content: '<div style="margin-bottom:1rem;">' +
        ...
        '</div>' +
        '<div style="margin-bottom:1rem;">' +
        '<div style="font-weight:700; color:var(--text-bright); font-size:0.9rem; margin-bottom:6px;">v0.10.86-alpha <span style="color:var(--text-muted); font-weight:400; font-size:0.75rem;">(Abril 2026)</span></div>' +
        '<p><b>Drag-and-drop para formar duplas</b> — Com Sortear desligado, arraste um jogador sobre outro para formar dupla. Cards ficam azul (T1) e vermelho (T2), reorganizados em colunas por time. Link "desfazer" para resetar.</p>' +
        '</div>' +
        '<div style="margin-bottom:1rem;">' +
