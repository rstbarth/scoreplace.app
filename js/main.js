  ...
  var helpSections = [
    ...
    },
    {
      ...
      content: '<div style="margin-bottom:1rem;">' +
        ...
        '<p><b>Correção: após o Suíço classificatório, bracket eliminatório aparece continuamente</b> — Em torneios que usavam Suíço como resolução de potência de 2 (ex: 20 inscritos → 2 rodadas Suíço → top 16 eliminatória), assim que a última rodada Suíço era fechada, a tela caía num estado "Nenhuma rodada gerada ainda / 🎲 Iniciar Primeira Rodada" por uns instantes — apagando a sensação de continuidade do torneio. A transição para a eliminatória agora faz o bracket (já desenhado pelo sorteio automático) aparecer imediatamente na tela. Bônus: abaixo do bracket aparece um card recolhido "🎯 Fase Classificatória — Top N" com botão <code>Mostrar</code>/<code>Ocultar</code>, dando acesso rápido ao recap do Suíço (classificação final + jogos de cada rodada) sem poluir a visualização principal. Fluxo coerente: o organizador vê as chaves já desenhadas seguirem adiante, com transparência do que aconteceu antes.</p>' +
        '</div>' +
