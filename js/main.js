  ...
  var helpSections = [
    ...
    },
    {
      ...
      content: '<div style="margin-bottom:1rem;">' +
        '<div style="font-weight:700; color:var(--text-bright); font-size:0.9rem; margin-bottom:6px;">v0.10.61-alpha <span style="color:var(--text-muted); font-weight:400; font-size:0.75rem;">(Abril 2026)</span></div>' +
        '<p><b>Live scoring UX</b> — Placares e botões maiores em celular retrato. Contagem de sets acima dos nomes suprimida (já exibida abaixo). Botão Tie-break permanente durante prorrogação para ativar a qualquer momento. Nomes padrão consistentes: Parceiro, Adversário 1, Adversário 2.</p>' +
        '</div>' +
