  ...
  var helpSections = [
    ...
    },
    {
      ...
      content: '<div style="margin-bottom:1rem;">' +
        ...
        '</div>' +
        '<div style="margin-bottom:1rem;">' +
        '<div style="font-weight:700; color:var(--text-bright); font-size:0.9rem; margin-bottom:6px;">v0.10.82-alpha <span style="color:var(--text-muted); font-weight:400; font-size:0.75rem;">(Abril 2026)</span></div>' +
        '<p><b>Sortear desligado por padrão</b> — Com sorteio desligado: times fixos (Parceiro + Adversários) com cores azul/vermelho em duas colunas. Com sorteio ligado: 4 cards neutros sem cor de time; ao iniciar, duplas sorteadas aleatoriamente e jogadores sem nome recebem rótulo pelo time (Parceiro/Adversário).</p>' +
        '</div>' +
        '<div style="margin-bottom:1rem;">' +
