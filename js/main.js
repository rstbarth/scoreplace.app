  ...
  var helpSections = [
    ...
    },
    {
      ...
      content: '<div style="margin-bottom:1rem;">' +
        ...
        '</div>' +
        '<div style="margin-bottom:1rem;">' +
        '<div style="font-weight:700; color:var(--text-bright); font-size:0.9rem; margin-bottom:6px;">v0.10.79-alpha <span style="color:var(--text-muted); font-weight:400; font-size:0.75rem;">(Abril 2026)</span></div>' +
        '<p><b>Ordem de saque limpa</b> — Tela minimalista: 4 cards na ordem dos saques com drag-and-drop. Alternância entre times sempre garantida automaticamente. Botões "Iniciar Partida" e "Pular".</p>' +
        '</div>' +
        '<div style="margin-bottom:1rem;">' +
