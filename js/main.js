    ...
    },
    {
      ...
      content: '<p>A <b>Dashboard</b> é sua página principal — concentra torneios, próximas partidas, amigos no local e atalhos para as 4 áreas principais do app.</p>' +
        ...
        '<div style="background:rgba(16,185,129,0.06);border:1px solid rgba(16,185,129,0.15);border-radius:10px;padding:12px;margin-bottom:12px;">' +
          ...
          '<p><b>Sua presença ativa</b> — Pill no topo da dashboard quando você tem check-in ou plan ativo. Check-in mostra "📍 Você está em [Local] · expira em Xh" com dot verde pulsante. Plan mostra "🗓️ Planejado: [Local] hoje às HH:mm". Botões "Ver local" (abre modal do venue) e "Cancelar" (remove a presença silenciosamente). Silent quando não há presença — não polui a UI.</p>' +
