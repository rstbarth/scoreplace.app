  ...
  var helpSections = [
    ...
    },
    {
      ...
      content: '<div style="margin-bottom:1rem;">' +
        ...
        '</div>' +
        '<div style="margin-bottom:1rem;">' +
        '<div style="font-weight:700; color:var(--text-bright); font-size:0.9rem; margin-bottom:6px;">v0.10.90-alpha <span style="color:var(--text-muted); font-weight:400; font-size:0.75rem;">(Abril 2026)</span></div>' +
        '<p><b>Sync em tempo real completo</b> — Lado de quadra (courtLeft), ordem de saque, nomes e todo o estado do placar sincronizados via Firestore. Ações em um dispositivo são reproduzidas em todas as outras telas conectadas à mesma partida. Bolinha de saque arrastável inline com travamento após game 2.</p>' +
        '</div>' +
        '<div style="margin-bottom:1rem;">' +
