  ...
  var helpSections = [
    ...
    },
    {
      ...
      content: '<div style="margin-bottom:1rem;">' +
        ...
        '</div>' +
        '<div style="margin-bottom:1rem;">' +
        '<div style="font-weight:700; color:var(--text-bright); font-size:0.9rem; margin-bottom:6px;">v0.10.97-alpha <span style="color:var(--text-muted); font-weight:400; font-size:0.75rem;">(Abril 2026)</span></div>' +
        '<p><b>Landscape cabe na tela</b> — Placar, Games, nomes e botões com tamanhos proporcionais ao viewport em landscape (celular deitado). Placas de score com fonte clamp(3.5rem,14vw,7rem), Games com fonte menor, botões com min-height reduzido, colunas limitadas a 22vw/28vw. Setup mobile compacto. Sync de sala casual entre dispositivos.</p>' +
        '</div>' +
        '<div style="margin-bottom:1rem;">' +
