  ...
  var helpSections = [
    ...
    },
    {
      ...
      content: '<div style="margin-bottom:1rem;">' +
        ...
        '</div>' +
        '<div style="margin-bottom:1rem;">' +
        '<div style="font-weight:700; color:var(--text-bright); font-size:0.9rem; margin-bottom:6px;">v0.10.87-alpha <span style="color:var(--text-muted); font-weight:400; font-size:0.75rem;">(Abril 2026)</span></div>' +
        '<p><b>Ordem de saque com drag-and-drop</b> — Arrastar sacador reordena mantendo alternância obrigatória T1-T2-T1-T2. Definir o 1º sacador define automaticamente o 3º (companheiro). Funciona no desktop e touch. Setup com drag-and-drop para formar duplas.</p>' +
        '</div>' +
        '<div style="margin-bottom:1rem;">' +
