  ...
  var helpSections = [
    ...
    },
    {
      ...
      content: '<div style="margin-bottom:1rem;">' +
        ...
        '</div>' +
        '<div style="margin-bottom:1rem;">' +
        '<div style="font-weight:700; color:var(--text-bright); font-size:0.9rem; margin-bottom:6px;">v0.10.85-alpha <span style="color:var(--text-muted); font-weight:400; font-size:0.75rem;">(Abril 2026)</span></div>' +
        '<p><b>Drag-and-drop para formar duplas</b> — Com Sortear desligado, arraste um jogador sobre outro para formar dupla. Cards ficam azul (Time 1) e vermelho (Time 2). Usuário sempre no Time 1. Subtitle mostra times formados com opção de desfazer.</p>' +
        '</div>' +
        '<div style="margin-bottom:1rem;">' +
